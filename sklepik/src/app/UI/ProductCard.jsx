...
const ProductCard = ({ product}) => {
  ...
  return (
    ...
    >
        <div className="relative overflow-hidden rounded-lg group  h-[300px] lg:h-[400px] ">
            <AnimatePresence mode="wait">
              ...
              >
                <Image 
                    ...
                    onClick={() => setCurrentImageIndex((cureentImageIndex + 1) % product.images.length)}
